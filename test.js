		...
		if(err) {
			...
			switch(val) {
				...
				case "http://www.hollywoodreporter.com/sites/default/files/2012/10/penguin_books_random_house_a_l.jpg":
					...
					break;
				case "http://av.watch.impress.co.jp/docs/news/20141016_671560.html":
					assert.ok(data.title == "Android 5.0搭載で4K/30p+光学手ブレ補正の「Nexus 6」 - AV Watch", "Decoding page according to charset header. -- " + val);
				default:
